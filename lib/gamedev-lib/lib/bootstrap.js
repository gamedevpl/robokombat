...
(function(global, basePath) {
	...
	function define(moduleName, fn) {
		var module = fn();
		if (loadedModules[moduleName] instanceof Deferred)
			loadedModules[moduleName].resolve(loadedModules[moduleName] = module);
			...
			var queue = modules.map(function(module) {
				...
				if (loadedModules[moduleName])
					...
					loadScript(src, function() {
						if(!loadedModules[moduleName])
							loadedModules[moduleName] = new Deferred().then(function(module) {
	...
	loadScript("lib/gamedev-lib/lib/deferred.js", function() {
		ready = function(fn) {
			fn();
		}
